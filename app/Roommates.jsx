...
const Roommates = () => {
    ...
    const handleSaveData = async () => {
        try {
            await addDoc(collection(db, "roommatePreferences"), {
                timePreference: selectedOption,
                acceptableTimePreference: selectedOption2,
            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <View style={styles.answerContainer}>
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                            <Text style={{ color: "#4f000b", fontSize: 17 }}>Morning</Text>
                            <RadioButton
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                            <Text style={{ color: "#4f000b", fontSize: 17 }}>Night</Text>
                            <RadioButton
                ...
                <View>
                    ...
                    <View style={styles.acceptableAnswerContainer}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                            <Text style={{ color: "#4f000b", fontSize: 17 }}>Both</Text>
                            <RadioButton
...
const styles = StyleSheet.create({
    ...
    answerContainer: { //your answer container
        gap: 5,
    ...
    acceptableAnswerContainer: {
        ...
        paddingHorizontal: widthPercentageToDP(7),
        paddingVertical: widthPercentageToDP(3.5),
        height: heightPercentageToDP(16), // Adjust this value as needed
        borderWidth: 2,
        borderColor: "#f08080",
        borderRadius: 21,
        backgroundColor: "#fbc4ab",
    ...
    topContainer: { //answering questions title
