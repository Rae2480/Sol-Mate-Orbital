...
interface User {
  ...
  compatibility?: string; // Add compatibility to interface
}
...
const hardcodedUsers: User[] = [
  {
    ...
    preferences: {
      dailyRoutine: '',
      dailyRoutineAccept: [],
      dailyRoutineImportance: 'Not important',
      cleanliness: '',
      cleanlinessAccept: [],
      cleanlinessImportance: 'Not important',
      guestFrequency: '',
      guestFrequencyAccept: [],
      guestFrequencyImportance: 'Not important',
      noiseSensitivity: '',
      noiseSensitivityAccept: [],
      noiseSensitivityImportance: 'Not important',
      privacyNeeds: '',
      privacyNeedsAccept: [],
      privacyNeedsImportance: 'Not important',
    },
    compatibility: 'High',
  },
  {
...
const MatchingPage = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      // Combine hardcoded users with fetched users
      const combinedMatches = [...sortedMatches, ...hardcodedUsers];
